...
const ViewLocations = () => {
    ...
    useEffect(() => {
        if (dateOptions.length > 0) {
            setSelectedDate(dateOptions[0].startTime);
        }
        dispatch(fetchDateOptions(movieId));
        dispatch(fetchCinemas());
    }, [dispatch, dateOptions]);
    ...
    return (
        <div>
            <div className="movie-poster">
                {movieInfo && (
                    <>
                        ...
                        <p>
                            {movieInfo.release}&nbsp;{movieInfo.rating}&nbsp;
                            {movieInfo.runtime}
                        </p>
            ...
            <Button
                ...
                style={{
                    backgroundColor:
                        selectedLocation && selectedDate ? "#00A4BD" : "gray",
                    color:
                        selectedLocation && selectedDate ? "#FAFAFA" : "white",
                }}
            >
                View Showtimes
            </Button>
